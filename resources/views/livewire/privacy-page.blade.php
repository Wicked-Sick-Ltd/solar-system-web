<div class="mx-auto" style="max-width: var(--container-prose);">
    ...
    <div class="space-y-6 text-base leading-relaxed" style="color: var(--text);">
        ...
        <ul class="list-disc space-y-2 pl-5">
            ...
            <li><strong>Open-Meteo</strong> — {{ __('hourly cloud, visibility, humidity and wind forecasts for observer weather outlooks.') }} <a class="link-quiet underline" href="https://open-meteo.com/en/docs" rel="noopener" target="_blank">{{ __('Open-Meteo docs') }}</a></li>
