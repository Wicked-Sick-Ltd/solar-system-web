        ...
        <div class="surface overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody style="color: var(--text);">
                    ...
                    <tr class="border-b" style="border-color: var(--border);"><td class="px-4 py-3 font-mono text-xs">{{ config('session.cookie') }}</td><td class="px-4 py-3">{{ __('Keeps interactive pages working between requests (essential).') }}</td><td class="px-4 py-3">{{ __('Session') }}</td></tr>
                    <tr class="border-b" style="border-color: var(--border);"><td class="px-4 py-3 font-mono text-xs">XSRF-TOKEN</td><td class="px-4 py-3">{{ __('Protects forms against cross-site request forgery (essential).') }}</td><td class="px-4 py-3">{{ __('Session') }}</td></tr>
